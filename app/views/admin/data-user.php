    ...
    <div class="col-12">
        <div class="card">
                            ...
                            <tr>
                                ...
                                <td width="50">
                                    <div class="action px-2 d-flex gap-2">
                                        ...
                                        <a class="modalUpdtUser" href="<?= BASEURL ?>/updtUser/<?= $user['id_user'] ?>" data-bs-toggle="modal" data-bs-target="#tambahUser" data-id="<?= $user['id_user'] ?>">
                                        ...
                                        <a onclick="return confirm('yakin?')" class="" href="<?= BASEURL ?>/admin/deluser/<?= $user['id_user'] ?>" id="delete"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#FF4141" class="bi bi-trash" viewBox="0 0 16 16">
            ...
            <div class="btn-tambah d-flex justify-content-end p-3">
                ...
                <button type="button" class="btn btn-success p-2 modalAddUser" data-bs-toggle="modal" data-bs-target="#tambahUser">
                                ...
                                <div class="card-body">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td width='1'>:</td>
                                            <td><input type="text" class="form-control" name="password" value="" id="password"></td>
                                        </tr>
                                        <tr>
